...
app.use('/movie/in_theaters', function (req, res) {
    res.json(Mock.mock({
        'status': 200,
        'data': {
            "count": 1,
...
app.use('/movie/coming_soon', function (req, res) {
    res.json(Mock.mock({
        'status': 200,
        'data': {
            "count": 1,
...
app.use('/movie/top250', function (req, res) {
    res.json(Mock.mock({
        'status': 200,
        'data': {
            "count": 1,
...
app.use('/movie/subject', function (req, res) {
    res.json(Mock.mock({
        'status': 200,
        'data': {
            "rating": {
...
app.listen('8090', () => {
    console.log('run in 127.0.0.1:8090')
})